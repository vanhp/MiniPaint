...
class MyCanvasView (context:Context): View(context){
    ...
    private val paint = Paint().apply {
        ...
        isDither = true
        style = Paint.Style.STROKE      // line default: FILL
        strokeJoin = Paint.Join.ROUND   // line & curve join default: MITER
        strokeCap = Paint.Cap.ROUND     // end of line of cap default: BUTT
        strokeWidth = STROKE_WIDTH      // line width default: Hairline-width (really thin)
    }
    ...
    override fun onSizeChanged(width: Int, height: Int, oldwidth: Int, oldheight: Int) {
        ...
        // recyle old bitmap first when a new size is created
